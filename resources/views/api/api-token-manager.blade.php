    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="name" type="text" class="block mt-1 w-full" wire:model.defer="createApiTokenForm.name" autofocus />
    ...
    <x-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="px-4 py-2 mt-4 w-full font-mono text-sm text-gray-500 break-all bg-gray-100 rounded"
