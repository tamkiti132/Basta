<div x-data="{
    showModalReportGroup: @entangle('showModalReportGroup'),
}" x-init="
    $watch('showModalReportGroup', value => {
        if (value) {
