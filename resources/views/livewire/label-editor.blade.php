    ...
    <div x-cloak x-show="showLabelEditModal"
        ...
        <div x-on:click.away="$wire.closeLabelEditModal"
            ...
            <div class="flex items-center justify-between">
                <input type="text" name="label" class="w-10/12 rounded-lg" wire:model="labelName"
                ...
                <button x-on:click="$wire.createLabel()"
                    class="w-1/12 text-3xl text-center text-gray-600 cursor-pointer">
                    &#10003;</button>
            ...
            <div class="flex flex-col py-2">
                ...
                <div class="flex justify-between">
                    <input type="text" wire:model.defer="labelNames.{{ $label->id }}"
                        ...
                        class="w-full py-4 text-left border-none hover:bg-slate-100">
