        ...
        <div class="grid items-center grid-cols-2">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <div class="flex flex-col px-4 text-gray-800">
                                ...
                                <button class="block w-full p-2 text-left hover:bg-slate-100"
                                    onclick="location.href='{{ route('group.group_edit.edit', ['group_id' => $group_data['id']]) }}' ">
                                    グループ編集
                                </button>
                                @endcan

                                <button x-on:click="modal_report_group = true"
            ...
            <div x-cloak x-show="modal_report_group"
                ...
                <div x-on:click.away="modal_report_group = false"
                    ...
                    <form action="{{ route('group.storeGroupTypeReport') }}" method="POST"
                        ...
                        <div class="flex justify-end gap-4 pt-2">
                            <button type="button" class="px-1 py-2 border border-gray-300 w-28 hover:bg-slate-100"
                                x-on:click="modal_report_group = false">キャンセル</button>
                            <button type="submit"
