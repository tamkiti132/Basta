<x-app-layout>
    ...
    <div class="max-w-xl py-10 mx-auto sm:px-6 lg:px-8">
        <div class="px-6 py-6 mt-10 bg-white rounded-md shadow sm:mt-20">
            <div class="flex items-center justify-between">
                <div class="flex flex-col items-start mr-4">
                    <div class="flex items-center">
                        <img src="/images/google.png" alt="Google" class="w-6 h-6 mr-2 pointer-events-none">
                ...
                <div>
                    ...
                    @else
                        <button
                            ...
                            class="px-6 py-2 text-sm font-bold text-white bg-black border-0 rounded-md focus:outline-none hover:bg-gray-800"
                        >連携する</button>
                    @endif                    
                </div>
            </div>
