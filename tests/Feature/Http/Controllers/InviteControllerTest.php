...
class InviteControllerTest extends TestCase
{
   ...
   */
  public function test_joinGroup_with_valid_parameters()
  {
    // Arrange（準備）
    // グループを作成
   ...
   */
  public function test_joinGroup_with_nonexistent_group()
  {
    // Arrange（準備）
    // 存在しないグループID
   ...
   */
  public function test_joinGroup_with_different_user()
  {
    // Arrange（準備）
    // グループを作成
    $group = Group::factory()->create([
