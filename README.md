...
| メモ詳細ページ                                            | メンバーページ                                            |
| --------------------------------------------------------- | --------------------------------------------------------- |
| ![メモ詳細ページ](docs/main-page-images/メモ詳細画面.gif) | ![メンバーページ](docs/main-page-images/メンバー画面.png) |
| 説明                                                      | 説明                                                      |

| マイページ                                          | グループ編集ページ                                                |
| --------------------------------------------------- | ----------------------------------------------------------------- |
| ![マイページ](docs/main-page-images/マイページ.gif) | ![グループ編集ページ](docs/main-page-images/グループ編集画面.gif) |
| 説明                                                | 説明                                                              |

| メンバー一覧ページ                                            | リクエスト送信ページ |
| ------------------------------------------------------------- | -------------------- |
| ![メンバー一覧ページ](docs/main-page-images/メンバー一覧画面.png) | ![リクエスト送信ページ](docs/main-page-images/リクエスト送信画面.gif) |
| 説明                                                        | 説明                 |

| プロフィールページ | ソーシャルログイン設定ページ |
| ------------------ | ---------------------------- |
| ![プロフィールページ](docs/main-page-images/プロフィール.gif) | ![ソーシャルログイン設定ページ](docs/main-page-images/ソーシャルログイン設定画面.png) |
| 説明               | 説明                         |
...
| ユーザー一覧ページ                                                                      | ユーザー詳細ページ                                                                     |
| --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| ![ユーザー一覧ページ](docs/main-page-images/運営ユーザー用ページ/ユーザー一覧画面1.png) | ![ユーザー詳細ページ](docs/main-page-images/運営ユーザー用ページ/ユーザー詳細画面.gif) |
| 説明                                                                                    | 説明                                                                                   |

| グループ一覧ページ                                                                     | グループ詳細ページ                                                                     |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| ![グループ一覧ページ](docs/main-page-images/運営ユーザー用ページ/グループ一覧画面.png) | ![グループ詳細ページ](docs/main-page-images/運営ユーザー用ページ/グループ詳細画面.gif) |
| 説明                                                                                   | 説明                                                                                   |
